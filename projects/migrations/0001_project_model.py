# Generated by Django 3.0.6 on 2020-07-08 19:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='project_cover_image', to='projects.GalleryImage')),
            ],
        ),
        migrations.AddField(
            model_name='galleryimage',
            name='project',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='projects.Project', verbose_name='Project'),
        ),
    ]
